...
namespace MHSAlumni.Controllers
{
    public class OrganizationsController : Controller
    {
        ...
        public OrganizationsController(MhsaluminiContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Organizations != null ? 
                          ...
                          Problem("Entity set 'MhsaluminiContext.Organizations'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MhsaluminiContext.Organizations'  is null.");
            }
            var organization = await _context.Organizations.FindAsync(id);
            if (organization != null)
            {
